...
const PUBLIC_FALLBACK_URLS: Partial<Record<GqlChain, string>> = {
  ...
  [GqlChain.Arbitrum]: 'https://arb1.arbitrum.io/rpc',
  [GqlChain.Base]: 'https://mainnet.base.org',
  [GqlChain.Optimism]: 'https://mainnet.optimism.io',
  [GqlChain.Polygon]: 'https://polygon-rpc.com',
  [GqlChain.Avalanche]: 'https://api.avax.network/ext/bc/C/rpc',
  [GqlChain.Gnosis]: 'https://rpc.gnosischain.com',
  [GqlChain.Sepolia]: 'https://rpc.sepolia.org',
}
