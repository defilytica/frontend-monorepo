...
const FEE_TYPES: ReadonlySet<string> = new Set<string>([
  GqlPoolAprItemType.DynamicSwapFee_24H,
  GqlPoolAprItemType.SwapFee,
  GqlPoolAprItemType.SwapFee_24H,
  GqlPoolAprItemType.SwapFee_7D,
  GqlPoolAprItemType.SwapFee_30D,
])
...
const YIELD_TYPES: ReadonlySet<string> = new Set<string>([
  ...
  GqlPoolAprItemType.Surplus_7D,
  GqlPoolAprItemType.Surplus_30D,
])
